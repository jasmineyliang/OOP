...
public class TestCell {
	...
	////////////////////////////////////////////////////////////////////////////////////	  
		  ...
		  Cell c = new Cell(true, born2, survive2);
		  
//////////////////////////////////////////////////////////////////////////////////////////
		  
		                                                                //Expected true 
		           System.out.println(c.isAlive()); //test 1
////////////////////////////////////////////////////////////////////////////////////////
		  
		 /*** Adds three neighboring cells which are alive.*/
		  
		           ArrayList<Cell> n = new ArrayList<>(); for(int i = 1; i <= 3; i++) { n.add(new
				  Cell(true,born1,survive1)); } 
		          
		          c.setNeighbors(n);
				  
				  c.setIsAliveNextGeneration();
				  
				                                                        // Expected false - there are exactly three alive neighbors of c // The next
				  //generation of c should die due to "overpopulation"
				  System.out.println(c.isAliveAfterNextGeneration()); //test 2
////////////////////////////////////////////////////////////////////////////////////////				  
				  
				  c.nextGeneration();
				  
				                                                         //Expected false 
				  System.out.println(c.isAlive());//test 3
///////////////////////////////////////////////////////////////////////////////////////	
				  c.setIsAliveNextGeneration();
				  
				                                                         // Expected true - there are exactly three alive neighbors of c // The next
				 // generation of c should be "born"
				  System.out.println(c.isAliveAfterNextGeneration());//test 4
///////////////////////////////////////////////////////////////////////////////////////					  
				  c.nextGeneration();
				  
				                                                           //Expected true 
				  System.out.println(c.isAlive());//test 5
